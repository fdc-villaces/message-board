                ...
                <div class="bg-white p-3">
                    ...
                    <ul
                        ...
                        <li class="flex items-center py-3">
                            ...
                            <span class="ml-auto"><?php echo date('F j, Y h:m A', strtotime($user['User']['created_at'])); ?></span>
                        </li>
                    </ul>
                </div>
                <!-- End of profile card -->
                    ...
                    <div class="text-gray-700">
                        <div class="grid md:grid-cols-2 text-sm">
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2"><?php echo ucwords($user['User']['name']);  ?></div>
                            </div>
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2"> 
                                    <a class="text-blue-800" href="mailto:<?php echo ucwords($user['User']['email']); ?>"><?php echo ucwords($user['User']['email']); ?></a>
                                </div>
                            </div>
                            <div class="grid grid-cols-2">
