					...
					<div class="flex-1 flex-wrap items-center">
						<div class="flex items-center">
							<div class="h-12 w-12 overflow-hidden relative rounded-full inline-block">
						 	<?php
		                      $image = $message['Sender']['sender_image'] ? '/profile/'.$message['Sender']['sender_image'] : 'https://banner2.cleanpng.com/20180410/bbw/kisspng-avatar-user-medicine-surgery-patient-avatar-5acc9f7a7cb983.0104600115233596105109.jpg';
	                   ...
	                   <div class="inline-block ml-4">
	                   	<label class="text-lg text-gray-700 font-semibold cursor-pointer"><?php echo ucwords($message['Receiver']['receiver_name']); ?></label>
	                   </div>
						</div>	
					</div>
					<div class="flex-1 flex items-center inline-block justify-end">
						<p class="text-sm text-gray-400 mr-4 font-medium tracking-wide"><?php echo date('Y/m/d H:i A', strtotime($message['Message']['created_at']));?></p>
